...
namespace SRV.BlastSnipe.UI.Dialogs
{
	...
	public class Dialog : View
	{
		...
		public bool Background
		{
			set
			{
				_backgroundImage.color = (value ? _backgroundColor : Color.clear);
			}
		}
		...
		public void AddButton(DialogButton btn)
		{
			...
			if (_buttonsCount > 2)
			{
				float x = button.GetComponent<RectTransform>().sizeDelta.x;
				Vector2 sizeDelta = _rectTransform.sizeDelta;
				_rectTransform.sizeDelta = new Vector2(sizeDelta.x + x, sizeDelta.y);
			}
		}
